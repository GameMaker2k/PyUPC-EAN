...
'''
    ...
    $FileInfo: httpd.py - Last Update: 06/12/2013 Ver. 2.4.2 RC 3  - Author: cooldude2k $
'''

import tempfile, uuid, re, os, sys, cherrypy, upcean, StringIO;
...
cherrypy.root = GenerateBarcodes();
