...
from upcean.versioninfo import (__author__, __build_python_info__,
                                __build_python_is_set__, __build_time__,
                                __build_time_utc__, __copyright__,
                                __copyright_year__, __credits__, __email__,
                                __license__, __license_string__,
                                __maintainer__, __project__, __project_url__,
                                __revision__, __status__, __version__,
                                __version_alt__, __version_date__,
                                __version_date_alt__, __version_date_info__,
                                __version_info__, get_build_python_info,
                                getcuryear, version_date, version_info)
...
bctype_dict = {
    ...
    'CODE93': "code93",
    'CODE128': "code128",
    'CODE128Alt': "code128alt",
    'CODE128Dec': "code128dec",
    'CODE128Hex': "code128hex",
    'CODE128Man': "code128man",
    'CODABAR': "codabar",
    'MSI': "msi",
    "GOODWILL": "goodwill"}
bctype_dict_alt = {
...
bctype_name = {
    ...
    "code93": "Code 93",
    "code128": "Code 128",
    "code128alt": "Code 128 Alt",
    "code128dec": "Code 128 Dec",
    "code128hex": "Code 128 Hex",
    "code128man": "Code 128 Man",
    'codabar': "Codabar",
    'msi': "MSI",
    "goodwill": "GOODWILL"}
