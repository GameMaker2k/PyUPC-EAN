...
def create_itf14(upc,outfile="./itf14.png",resize=1,hidecd=False,hidetext=False):
	...
	drawColorLine(upc_img, 13, 4, 13, 48, alt_text_color);
	drawColorLine(upc_img, 14, 4, 14, 48, alt_text_color);
	drawColorLine(upc_img, 15, 4, 15, 48, alt_text_color);
	...
	drawColorLine(upc_img, 20, 4, 20, 48, alt_text_color);
	NumZero = 0; 
	LineStart = 21; 
	LineSize = 48;
	...
	drawColorRectangle(upc_img, 0, 0, 43 + upc_size_add, 51, text_color);
	drawColorRectangle(upc_img, 1, 1, 41 + upc_size_add, 49, text_color);
	drawColorRectangle(upc_img, 2, 2, 39 + upc_size_add, 47, text_color);
	drawColorRectangle(upc_img, 3, 3, 37 + upc_size_add, 45, text_color);
