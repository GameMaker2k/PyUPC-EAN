...
def create_code32_barcode(
    upc, outfile="./code32.png", resize=1, hideinfo=(
    ...
    if (not hidetext):
        drawColorText(upc_img, 10 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), "A", barcolor[1], "ocrb", imageoutlib)
        NumTxtZero = 0
...
def create_pharmacode_barcode(
    upc, outfile="./pharmacode.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
        ...
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_pharmacode_barcode(
        upc,
        None,
        resize,
        hideinfo,
