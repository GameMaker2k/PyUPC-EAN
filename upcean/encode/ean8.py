...
def create_ean8_barcode(
    ...
    if (pilsupport and imageoutlib == "pillow"):
        upc_preimg = Image.new("RGB",
                               ((83 * barwidth[0]) + addonsize,
                                barheightadd + (9 * barwidth[1])))
        upc_img = ImageDraw.Draw(upc_preimg)
        upc_img.rectangle([(0, 0), ((83 * barwidth[0]) + addonsize,
    ...
    if (cairosupport and (imageoutlib == "cairo" or imageoutlib == "cairosvg")):
        if (outfileext == "SVG"):
            ...
            upc_preimg = cairo.ImageSurface(
                cairo.FORMAT_RGB24, (83 * barwidth[0]) + addonsize, barheightadd + (9 * barwidth[1]))
    ...
    while (end_bc_num < end_bc_num_end):
        ...
        BarNum += 1
    if (pilsupport and imageoutlib == "pillow"):
        new_upc_img = upc_preimg.resize((((83 * barwidth[0]) + addonsize) * int(
        ...
        if (outfileext == "SVG" or outfileext ==
            ...
            if (outfileext == "SVG"):
                new_upc_preimg = cairo.SVGSurface(imgoutfile,
                                                  ((83 * barwidth[0]) + addonsize) * int(resize),
                ...
                new_upc_preimg = cairo.ImageSurface(cairo.FORMAT_RGB24, ((
                    83 * barwidth[0]) + addonsize) * int(resize), (barheightadd + (9 * barwidth[1])) * int(resize))
        else:
            new_upc_preimg = cairo.ImageSurface(cairo.FORMAT_RGB24,
                                                ((83 * barwidth[0]) + addonsize) * int(resize),
                                                (barheightadd + (9 * barwidth[1])) * int(resize))
    ...
    if (not hidetext):
        ...
        drawColorText(upc_img, 10 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(LeftLeftDigit)[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (19 +
                                         (19 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(LeftLeftDigit)[1], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (26 +
                                         (24 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(LeftRightDigit)[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (32 +
                                         (29 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(LeftRightDigit)[1], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (45 +
                                         (46 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(RightLeftDigit)[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (51 +
                                         (51 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(RightLeftDigit)[1], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (58 +
                                         (56 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(RightRightDigit)[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (64 +
                                         (61 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(RightRightDigit)[1], barcolor[1], "ocrb", imageoutlib)
...
def create_gtin8_barcode(
    upc, outfile="./gtin8.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_ean8_barcode(
        upc,
        outfile,
        resize,
        hideinfo,
...
def create_ucc8_barcode(
    upc, outfile="./ucc8.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
