...
'''
    ...
    $FileInfo: goodwill.py - Last Update: 8/18/2023 Ver. 2.10.0 RC 1 - Author: cooldude2k $
'''
...
def create_goodwill_barcode(
    ...
    if (cairosupport and (imageoutlib == "cairo" or imageoutlib == "cairosvg")):
        ...
        upc_img.fill()
    if (pilsupport and imageoutlib == "pillow"):
        new_upc_img = upc_preimg.resize(((113 +
                                          addonsize) *
                                         int(resize), (barheight[1] +
                                                       (45 *
                                                        barwidth[0])) *
