...
def create_ean5sup_barcode(
    upc, outfile="./ean5_supplement.png", resize=1, hideinfo=(
    ...
    while (NumZero < len(LeftDigit)):
        ...
        NumZero += 1
    if (pilsupport and imageoutlib == "pillow"):
        new_upc_img = upc_preimg.resize(((56 *
                                          barwidth[0]) *
                                         int(resize), (barheightadd +
                                                       (9 *
                                                        barwidth[1])) *
                                         int(resize)), Image.NEAREST)
        del (upc_img)
        del (upc_preimg)
        ...
        if (outfileext == "SVG" or outfileext ==
            ...
            if (outfileext == "SVG"):
                new_upc_preimg = cairo.SVGSurface(imgoutfile,
                                                  ((56 * barwidth[0]) + addonsize) * int(resize),
    ...
    if (not hidetext):
        drawColorText(upc_img, 10 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), LeftDigit[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (16 +
                                         (15 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), LeftDigit[1], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (24 +
                                         (24 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), LeftDigit[2], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (32 +
                                         (32 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), LeftDigit[3], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (40 +
                                         (40 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), LeftDigit[4], barcolor[1], "ocrb", imageoutlib)
    exargdict = {}
...
def create_ean5_barcode(
    upc, outfile="./ean5.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
    ...
    upc_img.rectangle([(0,
                        0),
                       (((56 * barwidth[0]) * int(resize)) + (8 * int(resize)),
                        (barheightadd + (9 * barwidth[1])) * int(resize))],
                      fill=barcolor[2])
