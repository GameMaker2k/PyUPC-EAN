...
def create_ean5sup_barcode(upc,outfile="./ean5_supplement.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=(1, 1),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255)),imageoutlib="pillow"):
 ...
 if(pilsupport and imageoutlib=="pillow"):
  upc_preimg = Image.new("RGB", ((56 * barwidth[0]), barheightadd + (9 * barwidth[1])));
  upc_img = ImageDraw.Draw(upc_preimg);
  upc_img.rectangle([(0, 0), ((56 * barwidth[0]), barheightadd + (9 * barwidth[1]))], fill=barcolor[2]);
 if(cairosupport and (imageoutlib=="cairo" or imageoutlib=="cairosvg")):
  if(outfileext=="SVG"):
   upc_preimg = cairo.SVGSurface(None, (56 * barwidth[0]), barheightadd + (9 * barwidth[1]));
  elif(outfileext=="PDF"):
   ...
   upc_preimg = cairo.ImageSurface(cairo.FORMAT_RGB24, (56 * barwidth[0]), barheightadd + (9 * barwidth[1]));
 ...
 while (NumZero < len(LeftDigit)):
  ...
  NumZero += 1;
 if(pilsupport and imageoutlib=="pillow"):
  new_upc_img = upc_preimg.resize(((56 * barwidth[0]) * int(resize), (barheightadd + (9 * barwidth[1])) * int(resize)), Image.NEAREST);
  del(upc_img);
  del(upc_preimg);
 ...
 if(cairosupport and (imageoutlib=="cairo" or imageoutlib=="cairosvg")):
  ...
  if(outfileext=="SVG" or outfileext=="PDF" or outfileext=="PS" or outfileext=="EPS"):
   ...
   if(outfileext=="SVG"):
    ...
    new_upc_preimg = cairo.ImageSurface(cairo.FORMAT_RGB24, (56 * barwidth[0]) * int(resize), (barheightadd + (9 * barwidth[1])) * int(resize));
  else:
   new_upc_preimg = cairo.ImageSurface(cairo.FORMAT_RGB24, (56 * barwidth[0]) * int(resize), (barheightadd + (9 * barwidth[1])) * int(resize));
...
def create_ean5_barcode(upc,outfile="./ean5.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=(1, 1),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255)),imageoutlib="pillow"):
 ...
 upc_img = ImageDraw.Draw(upc_preimg);
 upc_img.rectangle([(0, 0), (((56 * barwidth[0]) * int(resize)) + (8 * int(resize)), (barheightadd + (9 * barwidth[1])) * int(resize))], fill=barcolor[2]);
 upc_sup_img = create_ean5sup_barcode(upc,None,resize,hideinfo,barheight,barwidth,textxy,barcolor,imageoutlib);
