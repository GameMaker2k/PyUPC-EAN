...
def create_ean2sup_barcode(
    upc, outfile="./ean2_supplement.png", resize=1, hideinfo=(
    ...
    while (NumZero < len(LeftDigit)):
        ...
        NumZero += 1
    if (pilsupport and imageoutlib == "pillow"):
        new_upc_img = upc_preimg.resize(((29 *
                                          barwidth[0]) *
        ...
        if (outfileext == "SVG" or outfileext ==
            ...
            if (outfileext == "SVG"):
                new_upc_preimg = cairo.SVGSurface(imgoutfile,
                                                  ((29 * barwidth[0]) + addonsize) * int(resize),
...
def create_ean2_barcode(
    upc, outfile="./ean2.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
    ...
    upc_img.rectangle([(0,
                        0),
                       (((29 * barwidth[0]) * int(resize)) + (8 * int(resize)),
                        (barheightadd + (9 * barwidth[1])) * int(resize))],
                      fill=barcolor[2])
