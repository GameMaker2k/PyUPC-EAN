...
def create_ean13_barcode(
    ...
    if (outfile is None):
        ...
        if (isinstance(oldoutfile, tuple) or isinstance(oldoutfile, list)):
            ...
            if (cairosupport and imageoutlib ==
                    "cairo" and outfileext == "SVG"):
                imageoutlib = "cairosvg"
            if (cairosupport and imageoutlib ==
                    "cairosvg" and outfileext != "SVG"):
                imageoutlib = "cairo"
    upc_pieces = None
    supplement = None
    ...
    if (len(upc) > 13 or len(upc) < 13):
        return False
    if (not re.findall(r"^([0-9]*[\.]?[0-9])",
                       str(resize)) or int(resize) < 1):
        resize = 1
    ...
    if (pilsupport and imageoutlib == "pillow"):
        upc_preimg = Image.new("RGB",
                               ((115 * barwidth[0]) + addonsize,
                                barheightadd + (9 * barwidth[1])))
        upc_img = ImageDraw.Draw(upc_preimg)
        upc_img.rectangle([(0, 0), ((115 * barwidth[0]) + addonsize,
                          barheightadd + (9 * barwidth[1]))], fill=barcolor[2])
    if (cairosupport and (imageoutlib == "cairo" or imageoutlib == "cairosvg")):
        if (outfileext == "SVG"):
            upc_preimg = cairo.SVGSurface(None,
                                          (115 * barwidth[0]) + addonsize,
                                          barheightadd + (9 * barwidth[1]))
        elif (outfileext == "PDF"):
            upc_preimg = cairo.PDFSurface(None,
                                          (115 * barwidth[0]) + addonsize,
                                          barheightadd + (9 * barwidth[1]))
        elif (outfileext == "PS" or outfileext == "EPS"):
            upc_preimg = cairo.PSSurface(None,
                                         (115 * barwidth[0]) + addonsize,
                                         barheightadd + (9 * barwidth[1]))
            if (outfileext == "EPS"):
            ...
            upc_preimg = cairo.ImageSurface(
                cairo.FORMAT_RGB24, (115 * barwidth[0]) + addonsize, barheightadd + (9 * barwidth[1]))
    ...
    while (end_bc_num < end_bc_num_end):
        ...
        BarNum += 1
    if (pilsupport and imageoutlib == "pillow"):
        new_upc_img = upc_preimg.resize((((115 * barwidth[0]) + addonsize) * int(
    ...
    if (cairosupport and (imageoutlib == "cairo" or imageoutlib == "cairosvg")):
        ...
        if (outfileext == "SVG" or outfileext ==
                "PDF" or outfileext == "PS" or outfileext == "EPS"):
            if (outfile is None):
                imgoutfile = None
            else:
                if (sys.version[0] == "2"):
            ...
            if (outfileext == "SVG"):
                ...
                new_upc_preimg = cairo.ImageSurface(
                    cairo.FORMAT_RGB24,
                    ((115 * barwidth[0]) + addonsize) * int(resize),
                    (barheightadd + (
    ...
    if (not hidetext):
        if (hidesn is not None and not hidesn):
            drawColorText(upc_img, 10 *
                          int(resize *
                              barwidth[1]), (2 +
                                             (2 *
                                              (int(resize) -
                                               1))) *
                          barwidth[0], cairo_addon_fix +
                          (barheight[0] +
                              (barheight[0] *
                               (int(resize) -
                                  1)) +
                              pil_addon_fix) +
                          (textxy[0] *
                              int(resize)), upc_matches[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (17 +
                                         (20 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[1])[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (23 +
                                         (25 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[1])[1], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (29 +
                                         (30 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[1])[2], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (35 +
                                         (35 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[1])[3], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (41 +
                                         (40 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[1])[4], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (47 +
                                         (45 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[1])[5], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (63 +
                                         (65 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[2])[0], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (69 +
                                         (70 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[2])[1], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (75 +
                                         (75 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[2])[2], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (81 +
                                         (80 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[2])[3], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (87 +
                                         (85 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[2])[4], barcolor[1], "ocrb", imageoutlib)
        drawColorText(upc_img, 10 *
                      int(resize *
                          barwidth[1]), (93 +
                                         (90 *
                      ...
                      (barheight[0] +
                          ...
                          pil_addon_fix) +
                      (textxy[1] *
                          int(resize)), list(upc_matches[2])[5], barcolor[1], "ocrb", imageoutlib)
        if (hidecd is not None and not hidecd):
            drawColorText(upc_img, 10 *
                          ...
                          (barheight[0] +
                              ...
                              pil_addon_fix) +
                          (textxy[0] *
                              int(resize)), ">", barcolor[1], "ocrb", imageoutlib)
    del (upc_img)
    if (pilsupport and imageoutlib == "pillow"):
        if (supplement is not None and len(supplement) == 2):
...
def create_gtin13_barcode(
    upc, outfile="./gtin13.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
...
def create_ucc13_barcode(
    upc, outfile="./ucc13.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
...
def create_ean13_from_upca_barcode(
    upc, outfile="./upca.png", resize=1, hideinfo=(
        True, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
...
def draw_ean13_from_upca_barcode(
    upc, resize=1, hideinfo=(
        True, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_ean13_from_upca_barcode(
        upc,
        None,
        resize,
        hideinfo,
...
def encode_ean13_from_upca_barcode(
    upc, resize=1, hideinfo=(
        True, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
