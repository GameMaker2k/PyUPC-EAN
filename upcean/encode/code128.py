...
from upcean.convert import (convert_ascii_code128_to_hex_code128,
                            convert_text_to_hex_code128_manual_with_checksum,
                            convert_text_to_hex_code128_with_checksum)
...
def create_code128hex_barcode(
    upc, outfile="./code128.png", resize=1, hideinfo=(
        ...
        if (outfileext == "SVG" or outfileext ==
            ...
            if (outfileext == "SVG"):
                new_upc_preimg = cairo.SVGSurface(imgoutfile,
                                                  ((34 * barwidth[0]) + addonsize) * int(resize),
            ...
            if (len(upc_print[NumTxtZero]) == 1):
                drawColorText(upc_img, 10 *
                              ...
                              (barheight[0] +
                                  ...
                                  pil_addon_fix) +
                              (textxy[1] *
                                  int(resize)), upc_print[NumTxtZero], barcolor[1], "ocrb", imageoutlib)
            ...
            if (len(upc_print[NumTxtZero]) == 2):
                drawColorText(upc_img, 10 *
                              ...
                              (barheight[0] +
                                  ...
                                  pil_addon_fix) +
                              (textxy[1] *
                                  int(resize)), upc_print[NumTxtZero][0], barcolor[1], "ocrb", imageoutlib)
                ...
                drawColorText(upc_img, 10 *
                              ...
                              (barheight[0] +
                                  ...
                                  pil_addon_fix) +
                              (textxy[1] *
                                  int(resize)), upc_print[NumTxtZero][1], barcolor[1], "ocrb", imageoutlib)
        ...
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_code128hex_barcode(
        upc,
        None,
        resize,
        hideinfo,
        ...
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_code128alt_barcode(
        upc,
        None,
        resize,
        hideinfo,
        ...
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_code128dec_barcode(
        upc,
        None,
        resize,
        hideinfo,
        ...
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
                        (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return create_code128man_barcode(
        upc,
        None,
        resize,
        hideinfo,
