        ...
        if (hidecd is not None and not hidecd):
            drawColorText(upc_img, 10 *
                          ...
                          (barheight[0] +
                              ...
                              pil_addon_fix) +
                          (textxy[2] *
                              int(resize)), upc_matches[3], barcolor[1], "ocrb", imageoutlib)
    del (upc_img)
    if (pilsupport and imageoutlib == "pillow"):
        if (supplement is not None and len(supplement) == 2):
...
def create_ean12_barcode(
    upc, outfile="./ean12.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
...
def create_gtin12_barcode(
    upc, outfile="./gtin12.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
...
def create_ucc12_barcode(
    upc, outfile="./ucc12.png", resize=1, hideinfo=(
        False, False, False), barheight=(
            48, 54), barwidth=(
                1, 1), textxy=(
                    1, 1, 1), barcolor=(
