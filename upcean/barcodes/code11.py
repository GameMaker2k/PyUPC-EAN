...
def create_code11_barcode(upc,outfile="./code11.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=1,textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 ...
 upc_array['code'].append( [1, 0, 1, 1, 0, 0, 1] );
 ...
 drawColorLine(upc_img, 12, 4, 12, LineSize, barwidth, barcolor[0]);
 ...
 drawColorLine(upc_img, 21 + upc_size_add, 4, 21 + upc_size_add, LineSize, barwidth, barcolor[0]);
