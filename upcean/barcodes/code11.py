'''
    ...
    $FileInfo: code11.py - Last Update: 04/03/2014 Ver. 2.6.2 RC 1 - Author: cooldude2k $
'''
...
def create_code11_barcode(upc,outfile="./itf14.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 upc = str(upc);
 hidesn = hideinfo[0];
 hidecd = hideinfo[1];
 hidetext = hideinfo[2];
