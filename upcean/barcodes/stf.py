...
def create_stf_barcode(upc,outfile="./stf.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=1,textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 ...
 drawColorLine(upc_img, 14, 4, 14, barheight[0], barwidth, barcolor[0]);
 drawColorLine(upc_img, 15, 4, 15, barheight[0], barwidth, barcolor[2]);
 drawColorLine(upc_img, 16, 4, 16, barheight[0], barwidth, barcolor[0]);
 ...
 drawColorLine(upc_img, 24 + upc_size_add, 4, 24 + upc_size_add, barheight[0], barwidth, barcolor[0]);
 drawColorLine(upc_img, 25 + upc_size_add, 4, 25 + upc_size_add, barheight[0], barwidth, barcolor[2]);
 drawColorLine(upc_img, 26 + upc_size_add, 4, 26 + upc_size_add, barheight[0], barwidth, barcolor[0]);
 drawColorLine(upc_img, 27 + upc_size_add, 4, 27 + upc_size_add, barheight[0], barwidth, barcolor[0]);
 ...
 drawColorLine(upc_img, 44 + upc_size_add, 4, 44 + upc_size_add, barheight[0], barwidth, barcolor[2]);
 drawColorLine(upc_img, 45 + upc_size_add, 4, 45 + upc_size_add, barheight[0], barwidth, barcolor[2]);
 drawColorLine(upc_img, 46 + upc_size_add, 4, 46 + upc_size_add, barheight[0], barwidth, barcolor[2]);
