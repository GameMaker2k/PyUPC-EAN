'''
    ...
    $FileInfo: upce.py - Last Update: 10/21/2014 Ver. 2.6.9 RC 1 - Author: cooldude2k $
'''
...
def create_upce_barcode(upc,outfile="./upce.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 ...
 if(len(upc)==12):
  upc = convert_barcode_from_upca_to_upce(upc);
 if(len(upc)==13):
  upc = convert_barcode_from_ean13_to_upce(upc);
 if(len(upc)==7):
