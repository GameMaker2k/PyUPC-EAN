'''
    ...
    $FileInfo: codabar.py - Last Update: 03/24/2014 Ver. 2.5.8 RC 1 - Author: cooldude2k $
'''
...
def create_codabar_barcode(upc,outfile="./itf14.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 upc = str(upc);
 upc = upc.upper();
 hidesn = hideinfo[0];
 hidecd = hideinfo[1];
