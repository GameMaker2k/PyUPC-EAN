...
'''
    ...
    $FileInfo: code128.py - Last Update: 2/19/2023 Ver. 2.7.23 RC 1 - Author: cooldude2k $
'''
...
def create_code128_barcode(upc,outfile="./code128.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=1,textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 upc = str(upc).lower();
 hidesn = hideinfo[0];
 hidecd = hideinfo[1];
 hidetext = hideinfo[2];
 ...
 drawColorLine(upc_img, 9, 4, 9, LineSize, barwidth, barcolor[2]);
 ...
 drawColorLine(upc_img, 13, 4, 13, LineSize, barwidth, barcolor[2]);
 NumZero = 0; 
 LineStart = 14; 
 cur_set = 0;
 ...
 while (NumZero < len(upc_matches)):
  ...
  while (InnerUPCNum < len(left_barcolor)):
   ...
   InnerUPCNum += 1;
  NumZero += 1;
 drawColorLine(upc_img, 17 + upc_size_add, 4, 17 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 18 + upc_size_add, 4, 18 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 19 + upc_size_add, 4, 19 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 20 + upc_size_add, 4, 20 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 21 + upc_size_add, 4, 21 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 22 + upc_size_add, 4, 22 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 23 + upc_size_add, 4, 23 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 24 + upc_size_add, 4, 24 + upc_size_add, LineSize, barwidth, barcolor[2]);
 ...
 drawColorLine(upc_img, 28 + upc_size_add, 4, 28 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 29 + upc_size_add, 4, 29 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 30 + upc_size_add, 4, 30 + upc_size_add, LineSize, barwidth, barcolor[2]);
 drawColorLine(upc_img, 31 + upc_size_add, 4, 31 + upc_size_add, LineSize, barwidth, barcolor[2]);
...
def draw_code128_barcode(upc,resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=1,textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 return create_code128_barcode(upc,None,resize,hideinfo,barheight,barwidth,textxy,barcolor);
...
def create_code128alt_barcode(upc,outfile="./code128.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),barwidth=1,textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 upc = str(upc);
 hidesn = hideinfo[0];
 hidecd = hideinfo[1];
 hidetext = hideinfo[2];
