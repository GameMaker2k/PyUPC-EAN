...
'''
    ...
    $FileInfo: code128.py - Last Update: 2/18/2023 Ver. 2.7.21 RC 1 - Author: cooldude2k $
'''
...
def create_code128_barcode(upc,outfile="./code128.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 ...
 while (NumZero < len(upc_matches)):
  ...
  while (InnerUPCNum < len(left_barcolor)):
   ...
   InnerUPCNum += 1;
  NumZero += 1;
 drawColorLine(upc_img, 17 + upc_size_add, 4, 17 + upc_size_add, LineSize, barcolor[2]);
...
def create_code128_alt_barcode(upc,outfile="./code128.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 upc = str(upc);
 hidesn = hideinfo[0];
 hidecd = hideinfo[1];
 hidetext = hideinfo[2];
 ...
 return create_code128_barcode(upc,outfile,resize,hideinfo,barheight,textxy,barcolor);

def draw_code128alt_barcode(upc,resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 return create_code128alt_barcode(upc,None,resize,hideinfo,barheight,textxy,barcolor);
