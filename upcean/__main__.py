'''
    ...
    $FileInfo: __main__.py - Last Update: 11/26/2019 Ver. 2.7.17 RC 1 - Author: cooldude2k $
'''
...
if(getargs.getinfo is not None):
 print("{getmyinfo}".format(getmyinfo=getinfolist.get(getargs.getinfo, getinfolist['pyupceandir'])));
