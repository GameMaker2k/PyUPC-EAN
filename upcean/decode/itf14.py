...
def decode_itf14_barcode(
    ...
    if (shiftcheck):
        ...
        while (prestartx < upc_img.size[0]):
            ...
            if (upc_img.getpixel((inprestartx, starty)) == barcolor[0]):
                if (inprestartx +
                        (4 * (barwidth[0] * int(resize))) > upc_img.size[0]):
                    return False
                if (threewidebar):
                    icount = 0
                    imaxc = 4
                    while (icount < imaxc):
                        ...
                        icount += 1
                    if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[2]
                            and curpixelist[2] == barcolor[0] and curpixelist[3] == barcolor[2])):
                        ...
                        while (preinprestartx < upc_img.size[0]):
                            precurpixelist = []
                            if ((
                                    preinprestartx + (9 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                                return False
                            icount = 0
                            imaxc = 9
                            while (icount < imaxc):
                            ...
                            barcodesize += 1
                            if ((precurpixelist[0] == barcolor[0] and precurpixelist[1] == barcolor[0] and precurpixelist[2] == barcolor[0] and precurpixelist[3] == barcolor[2] and precurpixelist[4]
                                    == barcolor[0] and precurpixelist[5] == barcolor[2] and precurpixelist[6] == barcolor[2] and precurpixelist[7] == barcolor[2] and precurpixelist[8] == barcolor[2])):
                                break
                        ...
                        while (icount < imaxc):
                            curpixelist.append(upc_img.getpixel(
                                (inprestartx + (icount * (barwidth[0] * int(resize))), starty)))
                            icount += 1
                        if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[2] and curpixelist[2] == barcolor[0] and curpixelist[3] == barcolor[2]) and (
                                curpixelist[4] == barcolor[0] and curpixelist[5] == barcolor[0] and curpixelist[6] == barcolor[0] and curpixelist[7] == barcolor[2] and curpixelist[8] == barcolor[0])):
                            startx = substartx
                            break
                else:
                    icount = 0
                    ...
                    if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[2]
                        ...
                        while (preinprestartx < upc_img.size[0]):
                            precurpixelist = []
                            if ((
                                    preinprestartx + (7 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                                return False
                            icount = 0
                            imaxc = 7
                            while (icount < imaxc):
                            ...
                            barcodesize += 1
                            if ((precurpixelist[0] == barcolor[0] and precurpixelist[1] == barcolor[0] and precurpixelist[2] == barcolor[2] and precurpixelist[3]
                                    == barcolor[0] and precurpixelist[4] == barcolor[2] and precurpixelist[5] == barcolor[2] and precurpixelist[6] == barcolor[2])):
                                break
                        barcodesize = int((barcodesize) / 2)
                        ...
                        while (icount < imaxc):
                            ...
                            icount += 1
                        if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[2] and curpixelist[2] == barcolor[0] and curpixelist[3] == barcolor[2]) and (
                                curpixelist[4] == barcolor[0] and curpixelist[5] == barcolor[0] and curpixelist[6] == barcolor[2] and curpixelist[7] == barcolor[0])):
                            startx = substartx
                            break
            prestartx += 1
        shiftxy = (0, shiftxy[1])
        ...
        while (preinprestartx < upc_img.size[0]):
            ...
            if (threewidebar):
                if ((preinprestartx +
                        (8 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                    return False
                icount = 0
                imaxc = 9
                while (icount < imaxc):
                ...
                if ((preinprestartx +
                        (6 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                    return False
                icount = 0
                imaxc = 7
                while (icount < imaxc):
    ...
    while (startx < endx):
        ...
        if (curpixel == barcolor[0]):
            ...
            if (nexpixel == barcolor[0] and startx < (
                    endx - (2 * (barwidth[0] * int(resize))) + 1)):
                incount = 0
                inbarwidth = barwidth[0] - 1
                while (incount <= inbarwidth):
        ...
        if (curpixel == barcolor[2]):
            ...
            nexpixel = upc_img.getpixel(
                (startx + (1 * (barwidth[0] * int(resize))), starty))
            if (nexpixel == barcolor[2] and startx < (
                    endx - (2 * (barwidth[0] * int(resize))) + 1)):
                incount = 0
                inbarwidth = barwidth[0] - 1
                while (incount <= inbarwidth):
...
def get_itf6_barcode_location(
    infile="./itf6.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_itf6_barcode(
        infile,
        resize,
        barheight,
        barwidth,
