...
def decode_stf_barcode(
    ...
    if (shiftcheck):
            ...
            if (upc_img.getpixel((inprestartx, starty)) == barcolor[0]):
                ...
                if (threewidebar):
                    ...
                    while (icount < imaxc):
                        ...
                        icount += 1
                    if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[0] and curpixelist[2] == barcolor[2] and curpixelist[3] == barcolor[0]
                            and curpixelist[4] == barcolor[0] and curpixelist[5] == barcolor[2] and curpixelist[6] == barcolor[0] and curpixelist[7] == barcolor[2])):
                        ...
                        while (preinprestartx < upc_img.size[0]):
                            precurpixelist = []
                            if ((
                                    preinprestartx + (14 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                                return False
                            icount = 0
                            imaxc = 14
                            while (icount < imaxc):
                            ...
                            barcodesize += 1
                            if ((precurpixelist[0] == barcolor[0] and precurpixelist[1] == barcolor[0] and precurpixelist[2] == barcolor[2] and precurpixelist[3] == barcolor[0] and precurpixelist[4]
                                    == barcolor[2] and precurpixelist[5] == barcolor[0] and precurpixelist[6] == barcolor[0] and precurpixelist[7] == barcolor[2] and precurpixelist[8] == barcolor[2])):
                                break
                        ...
                        while (icount < imaxc):
                            curpixelist.append(upc_img.getpixel(
                                (inprestartx + (icount * (barwidth[0] * int(resize))), starty)))
                            icount += 1
                        if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[0] and curpixelist[2] == barcolor[2] and curpixelist[3] == barcolor[0] and curpixelist[4] == barcolor[0] and curpixelist[5] == barcolor[2] and curpixelist[6] == barcolor[0] and curpixelist[7] == barcolor[2]) and (
                                curpixelist[8] == barcolor[0] and curpixelist[9] == barcolor[0] and curpixelist[10] == barcolor[2] and curpixelist[11] == barcolor[0] and curpixelist[12] == barcolor[2] and curpixelist[13] == barcolor[0] and curpixelist[14] == barcolor[0])):
                            startx = substartx
                            break
                else:
                    icount = 0
                    ...
                    if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[0] and curpixelist[2] == barcolor[2] and curpixelist[3] == barcolor[0]
                        ...
                        while (preinprestartx < upc_img.size[0]):
                            precurpixelist = []
                            if ((
                                    preinprestartx + (12 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                                return False
                            icount = 0
                            imaxc = 12
                            while (icount < imaxc):
        ...
        while (preinprestartx < upc_img.size[0]):
            ...
            if (threewidebar):
                if ((preinprestartx +
                        (14 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                    return False
                icount = 0
                imaxc = 14
                while (icount < imaxc):
                ...
                if ((preinprestartx +
                        (12 * (barwidth[0] * int(resize))) > upc_img.size[0])):
                    return False
                icount = 0
                imaxc = 12
                while (icount < imaxc):
...
def get_stf_barcode_location(
    infile="./stf.png", resize=1, barheight=(
        48, 54), barwidth=(
...
def get_code25_barcode_location(
    infile="./code25.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_code25_barcode(
        infile,
        resize,
        barheight,
        barwidth,
