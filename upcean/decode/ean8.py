...
def get_gtin8_barcode_location(
    infile="./gtin8.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_gtin8_barcode(
        infile,
        resize,
        barheight,
        barwidth,
...
def get_ucc8_barcode_location(
    infile="./ucc8.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_ucc8_barcode(
        infile,
        resize,
        barheight,
        barwidth,
