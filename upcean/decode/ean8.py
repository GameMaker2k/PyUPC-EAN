...
def decode_ean8_barcode(infile="./ean8.png",resize=1,barheight=(48, 54),barwidth=1,shiftxy=(0, 0),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255)),locatebarcode=False,imageoutlib="pillow"):
 ...
 if(locatebarcode):
  ...
  return (prestartx, startx, 8, endx, postendx); 
 startxalt = 0;
 listcount = 0;
 pre_upc_whole = [];
