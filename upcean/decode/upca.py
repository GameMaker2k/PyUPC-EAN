...
def decode_upca_barcode(
    ...
    if (shiftcheck):
        ...
        while (prestartx < upc_img.size[0]):
            ...
            if (upc_img.getpixel((inprestartx, starty)) == barcolor[0]):
                if (inprestartx +
                        (2 * (barwidth[0] * int(resize))) > upc_img.size[0]):
                    return False
                icount = 0
                imaxc = 3
                while (icount < imaxc):
                ...
                while (icount < imaxc):
                    curpixelist.append(upc_img.getpixel(
                        (inprestartx + (icount * (barwidth[0] * int(resize))), starty)))
                    icount += 1
                if ((curpixelist[0] == barcolor[0] and curpixelist[1] == barcolor[2] and curpixelist[2] == barcolor[0]) and (curpixelist[3] == barcolor[2] and curpixelist[4] == barcolor[0] and curpixelist[5]
                                                                                                                             == barcolor[2] and curpixelist[6] == barcolor[0] and curpixelist[7] == barcolor[2]) and (curpixelist[8] == barcolor[0] and curpixelist[9] == barcolor[2] and curpixelist[10] == barcolor[0])):
                    startx = substartx
                    break
            prestartx += 1
        shiftxy = (0, shiftxy[1])
    ...
    while (listcount < countlist):
        if (listcount < 6):
            leftbarcodevalue = left_barcode_dict.get(
                pre_upc_whole[listcount], False)
            if (not leftbarcodevalue):
                return False
            barcode_list.append(leftbarcodevalue)
        if (listcount > 5):
            rightbarcodevalue = right_barcode_dict.get(
                pre_upc_whole[listcount], False)
...
def get_ean12_barcode_location(
    infile="./ean12.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_ean12_barcode(
        infile,
        resize,
        barheight,
        barwidth,
...
def get_gtin12_barcode_location(
    infile="./gtin12.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_gtin12_barcode(
        infile,
        resize,
        barheight,
        barwidth,
...
def get_ucc12_barcode_location(
    infile="./ucc12.png", resize=1, barheight=(
        48, 54), barwidth=(
            1, 1), shiftcheck=False, shiftxy=(
                0, 0), barcolor=(
                    (0, 0, 0), (0, 0, 0), (255, 255, 255)), imageoutlib="pillow"):
    return decode_ucc12_barcode(
        infile,
        resize,
        barheight,
        barwidth,
