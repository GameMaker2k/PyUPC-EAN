...
def create_ean13(upc,outfile="./ean13.png",resize=1,hidecd=False):
	...
	drawColorLine(upc_img, 9, 10, 9, 48, alt_text_color);
	drawColorLine(upc_img, 10, 10, 10, 54, alt_text_color);
	drawColorLine(upc_img, 11, 10, 11, 54, text_color);
	drawColorLine(upc_img, 12, 10, 12, 54, alt_text_color);
	drawColorLine(upc_img, 13, 10, 13, 54, text_color);
	NumZero = 0; 
	LineStart = 14;
	...
	drawColorLine(upc_img, 60, 10, 60, 54, alt_text_color);
	NumZero = 0; 
	LineStart = 61;
	...
	drawColorLine(upc_img, 104, 10, 104, 54, alt_text_color);
	drawColorLine(upc_img, 105, 10, 105, 54, text_color);
