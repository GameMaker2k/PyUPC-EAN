...
def create_itf(upc,outfile="./itf.png",resize=1,hidecd=False):
	...
	while (NumTxtZero < len(upc_matches)):
		...
		drawColorText(upc_img, 11, LineTxtStart, 57, ArrayDigit[0], [0, 0, 0]);
		LineTxtStart += 9;
		drawColorText(upc_img, 11, LineTxtStart, 57, ArrayDigit[1], [0, 0, 0]);
		LineTxtStart += 9;
		NumTxtZero += 1;
	...
	while (NumZero < len(upc_matches)):
		...
		while (InnerUPCNum < len(left_text_color)):
			...
			InnerUPCNum += 1;
		NumZero += 1;
	drawColorLine(upc_img, 17 + upc_size_add, 4, 17 + upc_size_add, 47, [0, 0, 0]);
	drawColorLine(upc_img, 18 + upc_size_add, 4, 18 + upc_size_add, 47, [0, 0, 0]);
	drawColorLine(upc_img, 19 + upc_size_add, 4, 19 + upc_size_add, 47, [0, 0, 0]);
	drawColorLine(upc_img, 20 + upc_size_add, 4, 20 + upc_size_add, 47, [256, 256, 256]);
	drawColorLine(upc_img, 21 + upc_size_add, 4, 21 + upc_size_add, 47, [0, 0, 0]);
	drawColorLine(upc_img, 22 + upc_size_add, 4, 22 + upc_size_add, 47, [256, 256, 256]);
