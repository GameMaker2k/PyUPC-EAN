...
if(implib):
 barcodedtd = os.path.join(importlib.resources.files(__name__), "barcodes.dtd");
 barcodexsl = os.path.join(importlib.resources.files(__name__), "barcodes.xsl");
 barcodexsd = os.path.join(importlib.resources.files(__name__), "barcodes.xsd");
 barcoderng = os.path.join(importlib.resources.files(__name__), "barcodes.rng");
 barcodernc = os.path.join(importlib.resources.files(__name__), "barcodes.rnc");
