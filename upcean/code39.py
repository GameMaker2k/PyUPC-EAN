...
def create_code39(upc,outfile="./itf14.png",resize=1,hidecd=False):
	...
	drawColorText(upc_img, 10, 12, 58, "*", text_color);
	NumTxtZero = 0; 
	LineTxtStart = 28;
	while (NumTxtZero < len(upc_matches)):
		drawColorText(upc_img, 10, LineTxtStart, 57, upc_matches[NumTxtZero], text_color);
		LineTxtStart += 16;
		NumTxtZero += 1;
	drawColorText(upc_img, 10, LineTxtStart, 58, "*", text_color);
	...
	drawColorLine(upc_img, 17, 4, 17, 48, text_color);
	drawColorLine(upc_img, 18, 4, 18, 48, alt_text_color);
	drawColorLine(upc_img, 19, 4, 19, 48, text_color);
	drawColorLine(upc_img, 20, 4, 20, 48, text_color);
	drawColorLine(upc_img, 21, 4, 21, 48, text_color);
	drawColorLine(upc_img, 22, 4, 22, 48, alt_text_color);
	drawColorLine(upc_img, 23, 4, 23, 48, text_color);
	drawColorLine(upc_img, 24, 4, 24, 48, alt_text_color); 
	NumZero = 0; 
	LineStart = 25; 
	LineSize = 48;
	...
	drawColorLine(upc_img, 28 + upc_size_add, 4, 28 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 29 + upc_size_add, 4, 29 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 30 + upc_size_add, 4, 30 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 31 + upc_size_add, 4, 31 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 32 + upc_size_add, 4, 32 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 33 + upc_size_add, 4, 33 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 34 + upc_size_add, 4, 34 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 35 + upc_size_add, 4, 35 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 36 + upc_size_add, 4, 36 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 37 + upc_size_add, 4, 37 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 38 + upc_size_add, 4, 38 + upc_size_add, 48, text_color);
	drawColorLine(upc_img, 39 + upc_size_add, 4, 39 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 40 + upc_size_add, 4, 40 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 41 + upc_size_add, 4, 41 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 42 + upc_size_add, 4, 42 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 43 + upc_size_add, 4, 43 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 44 + upc_size_add, 4, 44 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 45 + upc_size_add, 4, 45 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 46 + upc_size_add, 4, 46 + upc_size_add, 48, alt_text_color);
	drawColorLine(upc_img, 48 + upc_size_add, 4, 48 + upc_size_add, 48, alt_text_color);
