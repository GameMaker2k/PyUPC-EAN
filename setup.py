...
'''
    ...
    $FileInfo: setup.py - Last Update: 8/18/2023 Ver. 2.10.0 RC 1 - Author: cooldude2k $
'''
...
if (pygenbuildinfo):
    ...
    verinfodata = re.sub("__build_time__ \\= \\{.*\\}\\;", '__build_time__ = {"timestamp": ' +
                         str(mycurtimestamp) +
                         ', "year": ' +
                         str(mycurtimetuple[0]) +
                         ', "month": ' +
                         str(mycurtimetuple[1]) +
                         ', "day": ' +
                         str(mycurtimetuple[2]) +
                         ', "hour": ' +
                         str(mycurtimetuple[3]) +
                         ', "minute": ' +
                         str(mycurtimetuple[4]) +
                         ', "second": ' +
                         str(mycurtimetuple[5]) +
                         '};', verinfodata)
    ...
    verinfodata = re.sub("__build_time_utc__ \\= \\{.*\\}\\;", '__build_time_utc__ = {"timestamp": ' +
                         str(utccurtimestamp) +
                         ', "year": ' +
                         str(utccurtimetuple[0]) +
                         ', "month": ' +
                         str(utccurtimetuple[1]) +
                         ', "day": ' +
                         str(utccurtimetuple[2]) +
                         ', "hour": ' +
                         str(utccurtimetuple[3]) +
                         ', "minute": ' +
                         str(utccurtimetuple[4]) +
                         ', "second": ' +
                         str(utccurtimetuple[5]) +
                         '};', verinfodata)
    linuxdist = None
    try:
