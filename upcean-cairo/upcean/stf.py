'''
    ...
    $FileInfo: stf.py - Last Update: 11/27/2013 Ver. 2.5.4 RC 1  - Author: cooldude2k $
'''
...
def create_stf(upc,outfile="./stf.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 upc = str(upc);
 hidesn = hideinfo[0];
 hidecd = hideinfo[1];
 hidetext = hideinfo[2];
 ...
 if(hidetext==False):
  ...
  while (NumTxtZero < len(upc_matches)):
   drawColorText(upc_img, 10, LineTxtStart, ((barheight[0] + 14) - 5) + textxy[1], upc_matches[NumTxtZero], barcolor[1]);
   LineTxtStart += 14;
   NumTxtZero += 1;
...
def draw_stf(upc,resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 return create_stf(upc,None,resize,hideinfo,barheight,textxy,barcolor);
