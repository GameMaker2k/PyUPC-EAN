'''
    ...
    $FileInfo: code93.py - Last Update: 11/27/2013 Ver. 2.5.4 RC 1  - Author: cooldude2k $
'''
...
def create_code93(upc,outfile="./itf14.png",resize=1,hideinfo=(False, False, False),barheight=(48, 54),textxy=(1, 1, 1),barcolor=((0, 0, 0), (0, 0, 0), (255, 255, 255))):
 ...
 if(hidetext==False):
  ...
  while (NumTxtZero < len(upc_print)):
   drawColorText(upc_img, 10, LineTxtStart, (barheight[1] + 3) + (textxy[1] * int(resize)), upc_print[NumTxtZero], barcolor[1]);
   LineTxtStart += 9;
   NumTxtZero += 1;
