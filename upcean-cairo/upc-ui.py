...
'''
    ...
    $FileInfo: upc-ui.py - Last Update: 12/04/2013 Ver. 2.5.4 RC 3  - Author: cooldude2k $
'''
...
barcode_list = {"Detect": "barcode", "UPC-A": "upca", "UPC-E": "upce", "EAN-13": "ean13", "EAN-8": "ean8", "EAN-2": "ean2", "EAN-5": "ean5", "ITF": "itf", "STF": "stf", "ITF-14": "itf14", "Code 11": "code11", "Code 39": "code39", "Code 93": "code93", "Codabar": "codabar", "MSI": "msi"};
def exit_ui(event):
 rootwin.quit();
...
listbox1 = OptionMenu(rootwin, listboxtxt1, "Detect", "UPC-A", "UPC-E", "EAN-13", "EAN-8", "EAN-2", "EAN-5", "STF", "ITF", "ITF-14", "Code 11", "Code 39", "Code 93", "Codabar", "MSI");
if(sys.platform=="win32"):
...
def GenerateBarcodeAlt(event):
 GenerateBarcode();
def ShowSaveDialog():
 return tkFileDialog.asksaveasfilename(parent=rootwin,title='Save Image As',filetypes=[('Windows Bitmap','*.bmp *.dib'), ('Portable Network Graphics','*.png'), ('JPEG / JFIF','*.jpg *.jpeg *.jpe *.jfif *.jfi'), ('CompuServer GIF','*.gif'), ('Tag Image File Format','*.tif *.tiff'), ('Adobe Portable Document Format','*.pdf'), ('Adobe Encapsulated PostScript','*.ps *.eps'), ('Personal Computer Exchange','*.pcx'), ('Portable Anymap Format','*.pbm *.pgm *.ppm'), ('All File Formats','*.*')]);
