...
class MainWin(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.tree.column("#0", minwidth=20, width=55,
                         stretch=True, anchor="center")
        self.tree.column("barcodes", minwidth=50, width=120,
                         stretch=True, anchor="center")
        self.tree.column("type", minwidth=40, width=65,
                         stretch=True, anchor="center")
        self.tree.column("comment", minwidth=120, width=240,
                         stretch=True, anchor="center")
...
class SettingWin(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.dean13 = ttk.Entry(self.frameMain, width=26,
        ...
        ttk.Label(self.frameMain, text='EAN-08 initial value:').grid(row=5,
                                                                     column=0, columnspan=2, sticky='w', pady=(5, 0))
        self.dean08 = ttk.Entry(self.frameMain, width=26,
        ...
        ttk.Label(self.frameMain, text='EAN-05 initial value:').grid(row=7,
                                                                     column=0, columnspan=2, sticky='w', pady=(5, 0))
        self.dean05 = ttk.Entry(self.frameMain, width=26,
        ...
        ttk.Label(self.framepdf, text='File saving directory:').grid(
            row=0, column=0, sticky='w', pady=(5, 0))
        self.dfiledir = ttk.Entry(
            self.framepdf, width=20, textvariable=self.default_dir)
