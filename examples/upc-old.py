...
'''
    ...
    $FileInfo: upc.py - Last Update: 8/18/2023 Ver. 2.10.0 RC 1 - Author: cooldude2k $
'''
...
if (sys.argv[1] == "genvw" or sys.argv[1]
        == "mkvw" or sys.argv[1] == "makevw"):
    taskfound = True
    if (len(sys.argv) < 3):
        print(str("command: " + sys.argv[0] + "\narguments: " +
              sys.argv[1] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "gencoupon" or sys.argv[1] ==
        "mkcoupon" or sys.argv[1] == "makecoupon"):
    taskfound = True
    if (len(sys.argv) < 5):
        print(str("command: " + sys.argv[0] + "\narguments: " +
              sys.argv[1] + "\nerror: syntax error missing arguments"))
    ...
    if (len(sys.argv[2]) == 1):
        if (len(sys.argv[3]) == 5):
            if (len(sys.argv[4]) == 3):
                if (len(sys.argv[5]) == 2):
                    print(str(make_coupon_upca(
                        sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5])))

if (sys.argv[1] == "genupca" or sys.argv[1] == "mkupca" or sys.argv[1] ==
        "makeupca" or sys.argv[1] == "genupc" or sys.argv[1] == "mkupc" or sys.argv[1] == "makeupc"):
    taskfound = True
    ...
    if (len(sys.argv[2]) == 12):
        create_upca(sys.argv[2], sys.argv[3], sys.argv[4],
                    (False, False, False), (48, 54))
    if (len(sys.argv[2]) < 12 or len(sys.argv[2]) > 12):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
        sys.exit(0)

if (sys.argv[1] == "genupce" or sys.argv[1]
        == "mkupce" or sys.argv[1] == "makeupce"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
    ...
    if (len(sys.argv[2]) == 8):
        create_upce(sys.argv[2], sys.argv[3], sys.argv[4],
                    (False, False, False), (48, 54))
...
if (sys.argv[1] == "genean13" or sys.argv[1] == "mkean13" or sys.argv[1] ==
        "makeean13" or sys.argv[1] == "genean" or sys.argv[1] == "mkean" or sys.argv[1] == "makeean"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
    ...
    if (len(sys.argv[2]) == 13):
        create_ean13(sys.argv[2], sys.argv[3], sys.argv[4],
                     (False, False, False), (48, 54))
...
if (sys.argv[1] == "genean8" or sys.argv[1]
        == "mkean8" or sys.argv[1] == "makeean8"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
    ...
    if (len(sys.argv[2]) == 8):
        create_ean8(sys.argv[2], sys.argv[3], sys.argv[4],
                    (False, False, False), (48, 54))
    if (len(sys.argv[2]) < 8 or len(sys.argv[2]) > 8):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "genstf" or sys.argv[1]
        == "mkstf" or sys.argv[1] == "makestf"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
        ...
        sys.exit(0)
    if (len(sys.argv[2]) > 0):
        create_stf(sys.argv[2], sys.argv[3], sys.argv[4],
                   (False, False, False), (48, 54))
    if (len(sys.argv[2]) < 1):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "genitf" or sys.argv[1]
        == "mkitf" or sys.argv[1] == "makeitf"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
    ...
    if (not len(sys.argv[2]) % 2 and len(sys.argv[2]) > 6):
        create_itf(sys.argv[2], sys.argv[3], sys.argv[4],
                   (False, False, False), (48, 54))
...
if (sys.argv[1] == "genitf14" or sys.argv[1] ==
        "mkitf14" or sys.argv[1] == "makeitf14"):
    taskfound = True
    ...
    if (len(sys.argv) < 4):
        ...
        sys.exit(0)
    if (not len(sys.argv[2]) % 2 and len(sys.argv[2]) > 6):
        create_itf14(sys.argv[2], sys.argv[3], sys.argv[4],
                     (False, False, False), (48, 54))
    if (len(sys.argv[2]) % 2 or len(sys.argv[2]) < 6):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "gencode39" or sys.argv[1] ==
        "mkcode39" or sys.argv[1] == "makecode39"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
        ...
        sys.exit(0)
    if (len(sys.argv[2]) > 1):
        create_code39(sys.argv[2], sys.argv[3],
                      sys.argv[4], (False, False, False), (48, 54))
    if (len(sys.argv[2]) < 1):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
        sys.exit(0)

if (sys.argv[1] == "gencode93" or sys.argv[1] ==
        "mkcode93" or sys.argv[1] == "makecode93"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
        ...
        sys.exit(0)
    if (len(sys.argv[2]) > 1):
        create_code93(sys.argv[2], sys.argv[3],
                      sys.argv[4], (False, False, False), (48, 54))
    if (len(sys.argv[2]) < 1):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "genbarcode" or sys.argv[1] ==
        "mkbarcode" or sys.argv[1] == "makebarcode"):
    taskfound = True
    if (len(sys.argv) < 5 or sys.argv[4] is None):
        sys.argv.append(1)
    if (len(sys.argv) < 4):
        print(str("command: " + sys.argv[0] + "\narguments: " +
              sys.argv[1] + "\nerror: syntax error missing arguments"))
        sys.exit(0)
    if (len(sys.argv[2]) == 8 or len(sys.argv[2]) == 12 or len(
            sys.argv[2]) == 13 or len(sys.argv[2]) == 14):
        create_barcode(sys.argv[2], sys.argv[3],
                       sys.argv[4], (False, False, False), (48, 54))
    if (len(sys.argv[2]) < 8):
        print(str("command: " + sys.argv[0] + "\narguments: " + sys.argv[1] +
              " " + sys.argv[2] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "genissn13" or sys.argv[1] ==
        "mkissn13" or sys.argv[1] == "makeissn13"):
    taskfound = True
    if (len(sys.argv) < 3):
        print(str("command: " + sys.argv[0] + "\narguments: " +
              sys.argv[1] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "genisbn13" or sys.argv[1] ==
        "mkisbn13" or sys.argv[1] == "makeisbn13"):
    taskfound = True
    if (len(sys.argv) < 3):
        print(str("command: " + sys.argv[0] + "\narguments: " +
              sys.argv[1] + "\nerror: syntax error missing arguments"))
...
if (sys.argv[1] == "genismn13" or sys.argv[1] ==
        "mkismn13" or sys.argv[1] == "makeismn13"):
    taskfound = True
    if (len(sys.argv) < 3):
        print(str("command: " + sys.argv[0] + "\narguments: " +
              sys.argv[1] + "\nerror: syntax error missing arguments"))
